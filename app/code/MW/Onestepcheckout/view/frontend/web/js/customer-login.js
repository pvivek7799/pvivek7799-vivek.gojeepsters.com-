...
define([
    ...
    'mage/validation',
    'jquery/ui'
], function ($, Request, UrlBuilder, localStorage) {
    $.widget("mw.customerLogin", {
        options: {},
        ...
        ajaxLogin: function () {
            ...
            var url = UrlBuilder.createUrl("onestepcheckout/customer/login", {}, false);
        ...
        ajaxRegister: function () {
            ...
            if (self.$passwordReg.val() == self.$confirmReg.val()) {
                ...
                var url = UrlBuilder.createUrl("onestepcheckout/customer/register", {}, false);
                Request.send(url, "post", params).done(function (result) {
                    var sections = ['cart','checkout-data','customer'];
                    localStorage.invalidate(sections);
                    localStorage.reload(sections, true);
        ...
        ajaxForgotPassword: function () {
            ...
            var url = UrlBuilder.createUrl("onestepcheckout/customer/forgotPassword", {}, false);
            Request.send(url, "post", params).done(function (result) {
