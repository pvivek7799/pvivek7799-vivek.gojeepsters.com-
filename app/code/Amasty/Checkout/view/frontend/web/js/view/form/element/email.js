define([
...
], function ($, registry, ko, Component, customerData, checkoutData, loginFormValidator) {
    'use strict';
    ...
    return Component.extend({
        ...
        getRequiredCharacterClassesNumber: function () {
            return parseInt(registry.get('checkoutProvider').requiredCharacterClassesNumber);
        },

        getMinimumPasswordLength: function () {
            return parseInt(registry.get('checkoutProvider').minimumPasswordLength);
        },
        ...
        _getCheckedEmailValue: function () {
            ...
            return customerData.checkedEmailValue ? customerData.checkedEmailValue : '';
        },

        _visibleLoginCaptcha: function () {
            if (this.loginCaptcha()) {
                this.loginCaptcha().currentCaptcha.setIsVisible(this.isPasswordVisible() && this.isCreateAccountAction());
            }
        },
