...
class AccountManagementTest extends \PHPUnit\Framework\TestCase
{
    ...
    private function getOrder()
    {
        ...
        $address->expects($this->once())->method('setCustomerDob');
        $address->expects($this->once())->method('getVatId')->willReturn(static::TAXVAT);
        ...
        $order->expects($this->once())->method('getBillingAddress')->willReturnReference($address);
        $order->expects($this->once())->method('getShippingAddress')->willReturnReference($address);
